...
if (count($incomestats)) {
	...
	$monthlyincome =  '<span class="stat" style="padding-right:2px;">'.ah_formatstat2('Monthly','sum').' </span><span class="label">'.ah_formatstat2("Monthly","count").'</span>';
	    ...
	    $content = '<div class="row">
				<div class="col-lg-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="smallstat">
						...
						<span class="value"><span class="stat">'.$totalclients.'</span> / <span class="stat">'.$clientsactive.'</span></span>	
				...
				<div class="col-lg-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="smallstat">
						...
						<span class="value"><span class="stat">'.$activeservices.'</span> / <span class="stat">'.$totalservices.'</span></span>							
					</div>
				</div>
				...
				<div class="col-lg-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="smallstat">
						...
						<span class="value"><span class="stat">'.$dueinvoices.'</span><span class="label">$'.$overdueinvoicesbal.'</span></span>	
					</div>
				</div>
			</div>';
